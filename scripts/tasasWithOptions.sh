...
easy=`perl scripts/removeFirst.pl -i -p -r both $1`
first=`perl scripts/removeFirst.pl -i -p -r keepfirst $1`
last=`perl scripts/removeFirst.pl -i -p -r keeplast $1`
echo "all words: $plain; first: $first; withoutfirst: $nofirst; last: $last; without last: $nolast; without both: $noboth; without both,ci,nopunct:  $easy"
