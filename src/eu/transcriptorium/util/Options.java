...
public class Options
{
	...
	{
		this.addOption("t", "tagger", true, "tagger");
		this.addOption("T", "tokenize", true, "tokenize or not");
		this.addOption("s", "sentences", true, "add sentence splitting to already tokenized file");
		this.addOption("c", "ctag", true, "use ctag attribute for PoS");
	}

	public void addOption(String letter, String name, boolean b,
			String description) 
	{
		options.addOption(letter,name,b,description);
	}
