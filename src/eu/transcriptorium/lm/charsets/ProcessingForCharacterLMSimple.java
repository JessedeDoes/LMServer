 ...
 *
 */
public class ProcessingForCharacterLMSimple extends SimpleTokenization
{
	/*
	...
	public String cleanWord(String w)
	{
		...
		{
			R.add(StringUtils.join(splitInCharacters(pre), " ") +   
		...
		if (main != null && main.length() > 0)
		{
			...
			R.add(StringUtils.join(splitInCharacters(main), " ") +   
					   hasFinalSpaceOnlyMarker) ; 
		}
