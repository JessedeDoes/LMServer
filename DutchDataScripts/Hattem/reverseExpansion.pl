...
while(<>)
{
  ...
  s/ <\/expan>/<\/expan> /g;
  s|\.</expan>|</expan>.|g;
  s|em<expan>m</expan>|e<expan>m</expan>m|g;
  s|l<expan>i</expan>b<expan>rae</expan>|<expan>librae</expan>|g;
  s|hooftzwe<expan>ere</expan>|hooftzwe<expan>er</expan>e|g;
  s|([Ee])n<expan>d</expan>e|$1n<expan>de</expan>|g;
  s|van<expan>der</expan>|vand<expan>er</expan>|g;
  s|some<expan>r</expan>|som<expan>er</expan>e|g;
  s|<expan></expan>||g;
  s|gade<expan>r</expan>e|gad<expan>er</expan>e|g; # pag. 135
  # rules
  foreach my $rule (@rules)
  {
    ...
    {
      s|$$rule[0]<expan>$$rule[2]</expan>|<choose n="$ruleId"><abbrev>$$rule[3]</abbrev><exp>$$rule[4]</exp></choose>|g;
    } elsif ($$rule[1]) # right context
    {
      ...
      {
        my $rcond = $1;
        s|<expan>$$rule[2]</expan>($rcond)|<choose n="$ruleId"><abbrev>$$rule[3]</abbrev><exp>$$rule[4]</exp></choose>$1|g;  
      } else
      {
        s|<expan>$$rule[2]</expan>$$rule[1]|<choose n="$ruleId"><abbrev>$$rule[3]</abbrev><exp>$$rule[4]</exp></choose>|g;
      }
    } else # no context needed
    {
      s|<expan>$$rule[2]</expan>|<choose n="$ruleId"><abbrev>$$rule[3]</abbrev><exp>$$rule[4]</exp></choose>|g;
    }
  }
  if (/<expan>/)
  {
  ...
  s/<expan>(.*?)<\/expan>/<choose n='-1'><expan>$1<\/expan><abbrev>UNKNOWN<\/abbrev><\/choose>/g;
  s/<exp>/<expan>/g;
  s/<\/exp>/<\/expan>/g;
