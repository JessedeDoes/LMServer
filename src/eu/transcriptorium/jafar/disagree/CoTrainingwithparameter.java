...
public class CoTrainingwithparameter {
	...
	public static void main(String[] args) throws IOException {
		...
		if(args==null)
		{
			...
			//			System.out.println("Selected  InRanks === "+InRanks.get(i)+"  OuRanks== "+OutRanks.get(i));
				...
				RetrivedBestMachesCleanedText(AddingToOut,OutputTextFileOriginal,args[6], args[9]);  
				...
				RemoveCleanedTextFilesFromCorpora(AddingToOut,args[6]);
	           ...
	           // Adding a set of high-confidence predictions to Out-domain sets which has been predicted by LM(out)
		        ...
		        OutputTextFile="SeletedNormalizedText.txt" ;
				...
				OutputTextFileOriginal="SeletedTextOriginalCleaned.txt" ;

				RetrivedBestMachesCleanedText(AddingToIn,OutputTextFileOriginal,args[6], args[9]);  
	            ...
	            RemoveCleanedTextFilesFromCorpora(AddingToIn,args[6]);
