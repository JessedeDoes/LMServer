...
public class CoTrainingNewExperiment {
	...
	public static void main(String[] args) throws IOException {
		...
		//		System.out.println("Out ranks "+InRanks.get(i)+"Out domain = "+RelatedFilesNameOut.get(i)+ "  In ranks "+OutRanks.get(i)+" In domain= "+RelatedFilesNameIn.get(i) );
			...
			PathIn="/mnt/Projecten/transcriptorium/Tools/languagemodeling/NewSetOfExperiment/In/";
			PathOut="/mnt/Projecten/transcriptorium/Tools/languagemodeling/NewSetOfExperiment/Out/";
			for(int i=0;i<Threshould;i++){
...
//		System.out.println(st);
	...
	//	PrintWriter output= new PrintWriter(new BufferedWriter(new FileWriter(outputTextFile)));
		...
		String listOfFiles="/mnt/Projecten/transcriptorium/Tools/languagemodeling/NewSetOfExperiment/ListofSelectedNormalizedFiles.txt";
