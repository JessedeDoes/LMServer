...
public class LanguageModelingPrompt
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		String InputFile = "/mnt/Projecten/transcriptorium/Tools/languagemodeling/ban.txt", Output = "/mnt/Projecten/transcriptorium/Tools/languagemodeling/TestSampleSelection/";
	...
	public static void NgramCount(String inputFile, String Output)
			throws IOException
	{
		// TODO Auto-generated method stub
		String FunctionSource = "/mnt/Projecten/transcriptorium/Tools/SRILM/bin";
		String[] cmd = { FunctionSource + "/i686-m64/ngram-count", "-sort",
				"-order", "2", "-kndiscount", "-text", inputFile, "-write",
				Output + "count.txt.gz" };
		...
		System.out
				.println("Here is the standard output of the NgramCount program:\n");
		String s;
		...
		System.out.println("outputttttttttttttttttttttttttttttttt== "
				+ System.console());
	...
	public static void RunLanguageModel(String inputFile, String cutoff)
			throws IOException
	{
		// TODO Auto-generated method stub
		String FunctionSource = "/mnt/Projecten/transcriptorium/Tools/languagemodeling/";
		String[] cmd = { "bash", FunctionSource + "trainingLMJava.sh",
				inputFile, cutoff };
	...
	public static void testPPLCode(String model, String inputFile, String output)
			throws IOException
	{
		// TODO Auto-generated method stub
		String FunctionSource = "/mnt/Projecten/transcriptorium/Tools/languagemodeling/";
		// System.out.println();
		String[] cmd = { "bash", FunctionSource + "testPPLJava.sh", model,
				inputFile, output };
